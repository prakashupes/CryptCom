...
long int p=11,q=7,n,t,flag,e[100],d[100],temp[100],j,m[100],en[100],i;
...
{//argc is num of agrument
 ...
 //argv contains original value of parameter
  ...
  //Code for write messages
    ...
    while(1)
    {
    	 bzero(decompress_string,100);
    	 printf("Client (type): " );
    	 huffmanMain();
    	 
    	 //fgets(buffer,1024,stdin);
    	 //printf("%s",buffer);
    	 valwrite = write( sockfd , decompress_string, strlen(decompress_string));
    	 if(valwrite<0)
  	   {
